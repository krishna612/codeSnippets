...
public class FindConnectedCompsTest {
  public static void main(String[] args) throws IOException {
		 ...
		 graph.print();
		 FindConnectedComps findCC = new FindConnectedComps(graph);
		 System.out.println(findCC.getNoOfConnectedComps());
		 System.out.println("enter a node which was in the original graph: ");
		 int tmp = Integer.parseInt(reader.readLine());
		 System.out.println(findCC.getComponentIdOfNode(new GraphNode(new Data(tmp))));
  }
}
