...
//655 720 520 550 610 640 555 610
public class Primsmstsub {
	...
	class EdgeGraph{
		...
		public void addEdge(Primsmstsub.Edge e){
			edgeList.add(e);
		}
	...
	class MinHeap{
		...
		PriorityQueue<Primsmstsub.Edge> heap = new PriorityQueue<Primsmstsub.Edge>();
		
		public void insert(Primsmstsub.Edge e){
			heap.add(e);
		}
		
		public Primsmstsub.Edge getMin(){
		    return heap.peek();
		}
	...
	class PrimsAlgo{
		Primsmstsub.EdgeGraph MST,graph;
		Primsmstsub.MinHeap minHeap;
		Primsmstsub prim = new Primsmstsub();
		boolean[] isPresent;
		
		public PrimsAlgo(Primsmstsub.EdgeGraph graph){
			this.graph = graph;
		...
		public Primsmstsub.EdgeGraph generateMST(int startingVertex){
    ...
    public static void main(String[] args) throws IOException {
		...
		int N,M,x,y,w;
		Primsmstsub prim = new Primsmstsub();
		Primsmstsub.EdgeGraph graph = prim.new EdgeGraph();
		Primsmstsub.Edge edge;
		...
		Primsmstsub.PrimsAlgo algo = prim.new PrimsAlgo(graph);
		Primsmstsub.EdgeGraph MST = algo.generateMST(finalVertex-1);
